...
//     // Are ANY of their purchases over 9000
//     console.log("this is the business we're testing", business)
//     console.log("this is what we're testing", business.orders.some(order => order > 9000))
//     return business.orders.some(order => order > 9000);
// })

const bigSpendersWithMethod = businesses.filter((business) =>
  business.orders.some((order) => order > 9000)
);

const bigSpendersWithForLoop = businesses.filter((business) => {
...
// console.log("this is with the method", bigSpendersWithMethod)
// console.log("this is with the for loop", bigSpendersWithForLoop)
